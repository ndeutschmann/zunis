...
for f in *; 
    do   if [ -d "$f" ]; 
        ...
        mkdir -p ../../../../utils/integrands/mg/$f/param 
        cp ../../Cards/param_card.dat ../../../../utils/integrands/mg/$f/param 
        cp {nexternal.inc,pmass.inc,param.log} ../../../../utils/integrands/mg/$f/param 
        cp matrix2py.so ../../../../utils/integrands/mg/$f
        python3 ../../../../benchmark_madgraph.py --process $f --pdf_type NNPDF23_nlo_as_0119   --pdf_dir ../../../MG5_aMC_v2_8_2/HEPTools/lhapdf6_py3/share/LHAPDF --db madgraph_$f --experiment_name madgraph_$f --config ../../../../benchmark_config_examples/madgraph_grid_config.yaml --debug --lhapdf_dir ../../../MG5_aMC_v2_8_2/HEPTools/lhapdf6_py3/lib/python3.*/site-packages --pdf
