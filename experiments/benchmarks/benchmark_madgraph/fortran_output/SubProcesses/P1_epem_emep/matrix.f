...
C     
C     Generated by MadGraph5_aMC@NLO v. 3.0.2.py3, 2020-05-25
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_3,AMP(1))
      CALL FFV2_4_3(W(1,2),W(1,1),GC_50,GC_59,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,4),W(1,3),W(1,5),GC_50,GC_59,AMP(2))
      CALL FFV1P0_3(W(1,4),W(1,1),GC_3,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,2),W(1,3),W(1,5),GC_3,AMP(3))
      CALL FFV2_4_3(W(1,4),W(1,1),GC_50,GC_59,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,2),W(1,3),W(1,5),GC_50,GC_59,AMP(4))
